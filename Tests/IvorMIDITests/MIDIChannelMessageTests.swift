...
extension MIDIChannelMessageTests {
    ...
    func hashable() {
        let msg1 = MIDIChannelMessage(statusByte: 0x90, dataBytes: [0x3c, 0x64])!  // swiftlint:disable:this force_unwrapping
        let msg2 = MIDIChannelMessage(statusByte: 0x90, dataBytes: [0x3c, 0x64])!  // swiftlint:disable:this force_unwrapping
        let msg3 = MIDIChannelMessage(statusByte: 0x80, dataBytes: [0x3c, 0x40])!  // swiftlint:disable:this force_unwrapping
        let set: Set<MIDIChannelMessage> = [msg1, msg2, msg3]
    ...
    func roundTrip() throws {
        let messages: [MIDIChannelMessage] = [.channelPressure(2, 64),
                                              .controlChange(3, .sustain, 127),
                                              .noteOff(4, 60, 64),
                                              .noteOn(5, 60, 100),
                                              .pitchBendChange(6, -1_234),
                                              .polyphonicPressure(7, 60, 32),
                                              .programChange(8, 5)]
        ...
        for message in messages {
            ...
            #expect(MIDIChannelMessage(statusByte: statusByte,
    ...
    @Test
    func statusByte_channel16() {
        let msg = MIDIChannelMessage.noteOn(16, 60, 100)

        #expect(msg.statusByte == 0x9f)
    }
}
